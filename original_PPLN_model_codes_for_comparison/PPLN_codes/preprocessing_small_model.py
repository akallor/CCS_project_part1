...
model, alphabet = torch.hub.load("facebookresearch/esm:main", "esm2_t6_8M_UR50D")   # not need to clone and/or install ESM
...
for itr in range(nIteration):
    ...
    token_representations = results["representations"][5]
